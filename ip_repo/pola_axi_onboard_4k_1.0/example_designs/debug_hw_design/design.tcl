...
proc create_ipi_design { offsetfile design_name } {
	...
	set pola_axi_onboard_4k_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:pola_axi_onboard_4k:1.0 pola_axi_onboard_4k_0 ]
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores xilinx.com:user:pola_axi_onboard_4k:1.0]]]]
